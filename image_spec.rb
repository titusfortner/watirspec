...
describe "Image" do
  ...
  describe "#exists?" do
    ...
    it "raises MissingWayOfFindingObjectException when 'how' argument is invalid" do
      expect { browser.image(:no_such_how, 'some_value').exists? }.to raise_missing_way_of_finding_object_exception
    end
  end
  ...
  it "raises UnknownObjectException if the image doesn't exist" do
    expect { browser.image(:index, 1337).file_size }.to raise_unknown_object_exception
  end

...
describe "Element" do
  ...
  describe "finding with unknown tag name" do
    ...
    it "raises MissingWayOfFindingObjectException if the attribute is invalid for the element type" do
      expect { browser.element(:for => "no title").exists? }.to raise_missing_way_of_finding_object_exception

      expect { browser.element(:value => //).exists? }.to raise_missing_way_of_finding_object_exception
    end
